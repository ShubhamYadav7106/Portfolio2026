<template>
    <section class="min-h-[40vh] md:min-h-[60vh] w-full" ref="experienceSection" id="experience-section">
        ...
        <div :class="['flex flex-col space-y-4 mb-12 md:mb-20 lg:mb-36 transition-all motion-reduce:transition-none duration-500 delay-300', visible ? 'translate-y-0 opacity-1 blur-0' : 'translate-y-4 opacity-0 blur-sm']">
            <ExperienceCard
